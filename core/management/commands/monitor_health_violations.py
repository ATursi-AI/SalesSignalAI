...
Usage:
    python manage.py monitor_health_violations --source nyc --days 30 --dry-run
    python manage.py monitor_health_violations --county nassau --days 30
    python manage.py monitor_health_violations --source suffolk --remote
"""
